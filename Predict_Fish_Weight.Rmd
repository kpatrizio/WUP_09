...
It appears we have an adjr2 score of 0.934.
...
along with weight and adding width.
Using these variables for our summary Smeltmodel3 and our sub-set models, 
it would appear that the best model to use would be the subset model with an 
adjr2 0f 0.965.  However, this model uses the variable Length2 rather than the
variable Length3.  The models smeltmodel2 and the inferential model show a lower 
adjr2 of 0.9551 which is lower than the 0.965 from the subset model.
